...
(function() {
  'use strict';
  define(['text!/Pages/device/add_video.html', 'avalon', 'api', 'page', 'avalon.cookie', 'select2'], function(pageMain, avalon, api, page) {
    var vm;
    ...
    vm = avalon.define({
      ...
      addSet: function() {
        ...
        return api.getApi('/task/add_video', {
          'setId': vm.setId,
      ...
      init: function(url) {
        ...
        if (vm.url.setId) {
          ...
          require(['logic/common/tips'], function(tips) {
            return tips.showTips('影片集未找到，请返回重新选择影片集', 'error');
          });
        }
        vm.s_platform = null;
        vm.link = '';
